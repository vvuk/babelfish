...
#endif
        // Optionally, disable either the mass storage interface (bit 0) or
        // the PICOBOOT interface (bit 1) when entering BOOTSEL mode via USB
        // (either VIA_BAUD_RATE or VIA_VENDOR_INTERFACE)
